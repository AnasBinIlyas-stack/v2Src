...
function Discordbanner() {
  ...
  return (
    <section className="discord-banner" ref={bannerRef}>
      <div className="inner">
        <div className="headings">
          <img
            src="/assets/images/Client-pages/discordbanner.webp"
            alt="..."
          ...
          <div ref={headingRef}>
            <h1 className="fw-bold textexpansiva-bold secondary-text text-center">
              Community offering <br /> real value
            </h1>
            <h5 className="fw-normal text-inter text-bit text-center">
              Collaborate, Create, and Earn Bitcoin!
            </h5>
          </div>
        </div>
      </div>
