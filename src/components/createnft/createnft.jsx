    ...
    try {
      return new Promise(async (resolve, reject) => {
        ...
        try {
          ...
          const encodedData = landingContract.methods.safeMint(pinataUrl).encodeABI();
          ...
          console.log("Error uploading image or sending transaction:", error.message);
        }
      });
    }
    catch (error) {
          ...
          <div className="top d-flex  gap-149">
            <div className="left">
              ...
              >
                {
                  image ? (
                    <img src={image} alt="" style={{ width: '100%', height: "100%", objectFit: 'cover', borderRadius: '6.884px' }} />
                  ) : (
              ...
              <input type="file" name="" id="upload" className="d-none" onChange={handleFileChange} />
          ...
          <div className="bottom">
            ...
            <div className="d-flex justify-content-between mt-42">
              ...
              <div className="right-side">
                <input type="checkbox" className="skip-stream" checked={unlockableContent} onChange={(e) => setUnlockableContent(e.target.checked)} />
              </div>
            </div>
            <div className="d-flex justify-content-between mt-42">
              <div className="left-side d-flex flex-column gap-8">
              ...
              <div className="right-side">
                <input type="checkbox" className="skip-stream" checked={explicitContent} onChange={(e) => setExplicitContent(e.target.checked)} />
              </div>
            </div>
