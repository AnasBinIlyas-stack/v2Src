  ...
  return (
    <section className="mainnftcards-sec">
      <div className="nft-inner">
        <div className="topnft-sec main text-white">
          <div className="head">
            <div className="left">
        ...
        <div className="latestcollection-sec main text-white">
          <div className="head">
            <div className="left">
        ...
        <div className="sold-sec main text-white">
          <div className="head">
            <div className="left">
        ...
        <div className="minted-sec main text-white">
          <div className="head">
            <div className="left">
