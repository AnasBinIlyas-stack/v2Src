...
function Marketplacecontent() {
  ...
  return (
    <section className="marketplacecontent-sec">
      <div className="inner">
        <div className="ist text-white" ref={istmarketplaceRef}>
        ...
        <div className="second text-white" ref={secondmarketplaceRef}>
        ...
        <div className="ist text-white" ref={thirdmarketplaceRef}>
          <div className="left" ref={thirdleftmarketplaceRef}>
            <h4 className="secondaryhead-text fw-bold textexpansiva-bold text-white">
        ...
        <div className="second text-white" ref={forthmarketplaceRef}>
        ...
        <div className="ist text-white" ref={fifthmarketplaceRef}>
        ...
        <div className="second text-white" ref={sixthmarketplaceRef}>
